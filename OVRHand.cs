    ...
    OVRMeshRenderer.IOVRMeshRendererDataProvider
{
    ...
    public bool medicalFirstUpdate = true;
    public bool medicalIsGrabbing = true;
    ...
    // MEDICAL: this updates finger pose, but keeps hand root pose tracking
